...
struct FilterPill: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .background(
                Capsule()
                    .fill(isSelected ? AnyShapeStyle(Color.couplyPrimaryGradient) : AnyShapeStyle(Color.couplyPeachLight))
            )
            .shadow(
        ...
        Button(action: onTap) {
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    HStack(spacing: 8) {
                        Circle()
                            .fill(isSent ? AnyShapeStyle(Color(hex: "A78BFA")) : AnyShapeStyle(Color.couplyPrimaryGradient))
